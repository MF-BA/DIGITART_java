 ...
 * @author fedi1
 */
public class Archive_backController implements Initializable {
    ...
    public void Showauction() {
        ...
        AuctionList = Auction_Services.Display_auction_details(Auction_Services.Display_back_archive());
